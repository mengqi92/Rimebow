    ...
    getChildren(element?: TreeItem): vscode.ProviderResult<TreeItem[]> {
        ...
        if (!element) {
            ...
            if (element.label === 'Default Configurations') {
                ...
                let defaultConfigPath: string = '/' + path.join('mnt', 'C', 'Program Files (x86)', 'Rime', 'weasel-0.14.3');
                ...
                let userConfigPath: string = '/' + path.join('mnt', 'c', 'Users', 'mengq', 'AppData', 'Roaming', 'Rime');
